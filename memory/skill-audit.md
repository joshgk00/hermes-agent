...
- `decision-moment-cards`: Still open; move job-specific checks and transport recovery into linked references. Estimated savings: ~1,500 tokens.
- `prompt-optimization-analyzer`: Still open; remove repeated activation guidance and retain one compact example. Estimated savings: ~170 tokens.
- `nightly-maintenance-routine`: Still open; remove the repeated class paragraph and merge duplicate cautions into workflow steps. Estimated savings: ~100 tokens.