...
_GATEWAY_LIFECYCLE_PATTERN = re.compile(
    ...
    # `bootout` is the modern spelling of `unload` — omitting it let a gateway
    # tear down its own launchd job and die before reloading it (2026-08-16 and
    # 2026-08-17, chief-of-staff profile, both times leaving no job to restart).
    r"|(?:launchctl\s+(?:kickstart|unload|load|stop|restart|submit|bootstrap|bootout)\b[^\n]*\bhermes[.\-]?gateway)"
